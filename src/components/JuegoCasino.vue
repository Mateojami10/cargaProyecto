    ...
    <div class="casino-container">
        ...
        <div v-if="!juegoTerminado && !juegoGanado">
            ...
            <div class="casino-slots">
                <HijoCasino :pokemon="pokemon1" />
                <HijoCasino :pokemon="pokemon2" />
                <HijoCasino :pokemon="pokemon3" />
            </div>
...
<script>
import { consumirApiFacade } from '@/clients/Cliente';
import HijoCasino from './HijoCasino.vue';
export default {
    name: 'JuegoCasino',
    components: {
        HijoCasino
